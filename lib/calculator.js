...
/**
 * Optimiert eine einzelne Warteschlange.
 *
 * Regeln:
 * - Ein Gebäude produziert seriell, also Gesamtzeit <= Stunden.
 * - Jeder Auftrag belegt einen Slot, also Gesamtanzahl <= Slots.
 * - Es dürfen verschiedene Produkte kombiniert werden.
 * - Bewertet wird die komplette Kombination, nicht nur ein einzelnes Produkt.
 *
 * Weil Hay Day-Slots max. 10 sind, können wir hier sauber per Dynamic Programming suchen.
 */
