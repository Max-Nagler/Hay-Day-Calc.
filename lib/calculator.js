...
function collectRequirements({
  ...
  if (depth > 20) {
    ...
    addToMap(displayIngredientsMap, product.key, amount);
  ...
  for (const recipe of recipeRows) {
    ...
    if (!ingredientProduct) {
      ...
      addToMap(displayIngredientsMap, recipe.ingredientKey || recipe.ingredient, ingredientAmount);
    ...
    if (ingredientHasRecipe && settings.intermediateMustBeProduced) {
      addToMap(displayIngredientsMap, ingredientProduct.key, ingredientAmount);
