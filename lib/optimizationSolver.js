...
.slice(0, model.settings.solverMode === "proof" ? Math.max(slotLimit * 4, 18) : Math.max(slotLimit * 2, 8));
...
const maxCombinationsPerBuilding = model.settings.solverMode === "proof" ? 40 : 12;
