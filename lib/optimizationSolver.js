...
export function solveOptimizationModel(model) {
  ...
  const items = [...model.products]
    ...
    // Die Optimierung läuft jetzt über /api/optimize serverseitig.
    // Deshalb darf die Suche wieder alle zulässigen Kandidaten berücksichtigen.
    ;
