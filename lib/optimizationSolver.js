...
const nonEmptyCombinations = dominanceResult.combinations.filter((combo) => combo.slots > 0).slice(0, 12);
...
const maxRuntimeMs = safeNumber(model.settings.maxRuntimeMs, 3500);
const beamWidth = safeNumber(model.settings.beamWidth, 80);
